...
public class Cliente  implements Serializable{	
	...
	public Cliente(Integer id, String nome, String email, String cpfOuCpf, TipoCliente tipo) {
		super();
		this.id = id;
		this.nome = nome;
		this.email = email;
		this.cpfOuCpf = cpfOuCpf;
	...
	public String getCpfOuCpf() {
		return cpfOuCpf;
	}

	public void setCpfOuCpf(String cpfOuCpf) {
		this.cpfOuCpf = cpfOuCpf;
	}
